...
import { FiUser, FiLogOut, FiMenu, FiSun, FiMoon, FiShield } from 'react-icons/fi';
...
export default function AdminNavbar({ onToggle, onSidebarToggle, showSidebarToggle = false }: AdminNavbarProps) {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          {(showSidebarToggle || onToggle) && (
            <button
              onClick={onToggle || onSidebarToggle}
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="hidden sm:inline-flex items-center px-2 py-1 text-xs font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded-full">
